...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-4%2C804%20rows-8250df">
...
> **Important:** this repository is a **public 4,804-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **4,805 domains** on the canonical page below.

**Public extract:** 4,804 rows · **Live catalog:** 4,805 domains
...
- `broker.csv` — public CSV extract (4,804 rows)
- `broker.json` — public JSON extract (4,804 rows)
...
| ----------------------- | ------------------------------------------------ |
| 4,804-row public sample | 4,805 live domains                               |
...
> Unique Domains. *Available .BROKER One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
