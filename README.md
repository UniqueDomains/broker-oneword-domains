...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-4%2C805%20rows-8250df">
...
- `broker.csv` — public CSV extract (4,805 rows)
- `broker.json` — public JSON extract (4,805 rows)
...
| ----------------------- | ------------------------------------------------ |
| 4,805-row public sample | 4,805 live domains                               |
